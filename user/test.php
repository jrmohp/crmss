...
<form method="post" action="../php/indexc.php">
    <div class="row well">

        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">

            <input type="text" id="fn" name="fn" class="form-control" placeholder="Name" required="true">

        </div>

        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
            <input type="mobile" id="mobile" name="mobile" class="form-control" placeholder="Mobile" required="true">
        </div>


        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12" >
            <input type="text" id="req" class="form-control" name="req" placeholder="Requirement" required="true">
        </div>
        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12" >
            <input type="email" id="email" class="form-control" name="emailo" placeholder="Email" required="true">
        </div>
        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
            <select name="city" class="form-control" required="true" id="city" required="true" >
        ...
        <div class="col-md-1 col-lg-1 col-sm-1 col-xs-4">
            <a href="#" data-toggle="tooltip" title="Whatsapp Available"><i class="fa fa-whatsapp fa-2"></i> <input type="checkbox" id="wa" name="wa" value="0"></a>
        </div>
        <br><br>

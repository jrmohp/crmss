            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
            		          ...
            		          <textarea class="pa form-control" required="" placeholder="Permanent Address" rows="5"  id="pa" name="pa"></textarea>
                     			</div>
                     </div>
	                 ...
	                 <div class="row">
	           		          ...
	           		          <textarea class="ta form-control" required="" placeholder="Temporary Address" rows="5" id="ta" name="ta"></textarea>
	           		          </div>
	                 </div>

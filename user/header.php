                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="http://crm.smartsolar.co.in/index">Dashboard</a></li>
                   ...
                   <li><a><i class="fa fa-users"></i>Customers<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="http://crm.smartsolar.co.in/addcustomer">Add Customer</a></li>
                      <li><a href="http://crm.smartsolar.co.in/viewcustomer">View Customers</a></li>
                      <li><a href="http://crm.smartsolar.co.in/singlemail">Send Mail To Customer</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-user"></i>Employee <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="http://crm.smartsolar.co.in/addemployee">Add Employee</a></li>
                      <li><a href="http://crm.smartsolar.co.in/viewemployee">view Employee</a></li>
                      <li><a href="http://crm.smartsolar.co.in/editemployee">Edit Employee</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i>Site Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="http://crm.smartsolar.co.in/addsite">Add Sites</a></li>
                      <li><a href="http://crm.smartsolar.co.in/viewsites">View Sites</a></li>
                      <li><a href="http://crm.smartsolar.co.in/addexpenses">Add Expense To Site</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i>Franchise Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="http://crm.smartsolar.co.in/addfranchise">Add Franchise</a></li>
                      <li><a href="http://crm.smartsolar.co.in/viewfranchise">View Franchise</a></li>
                      <li><a href="http://crm.smartsolar.co.in/franchisebilling">Billing</a></li>
                      <li><a href="http://crm.smartsolar.co.in/assigntofranchise">Assign Project</a></li>

        ...
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="#" class="waves-effect"><i class="mdi mdi-human-male-female fa-fw"></i> <span class="hide-menu">Customers<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="addcustomer.php"><i data-icon="&#xe026;" class="mdi mdi-account-plus mdi-18px fa-fw"></i> <span class="hide-menu">Add Customers</span></a></li>
                        <li><a href="viewcustomer.php"><i data-icon="&#xe025;" class="mdi mdi-account-box mdi-18px fa-fw"></i> <span class="hide-menu">View Customers</span></a></li>
                        <li><a href="editcustomerselect.php"><i class="mdi mdi-account-edit mdi-18px fa-fw"></i> <span class="hide-menu">Edit Customers</span></a></li>
                        <li><a href="singlemail.php"><i class="mdi mdi-email-variant mdi-18px fa-fw"></i> <span class="hide-menu">Send Mail to Customers</span></a></li>
                    </ul>
                </li>
                ...
                <li> <a href="forms.html" class="waves-effect"><i class="mdi mdi-file-multiple mdi-18px fa-fw"></i> <span class="hide-menu">Attendance <span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">

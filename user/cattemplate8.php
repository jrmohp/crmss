...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">100LPD Solar Water Heater</div>
                        ...
                        <div class="col-sm-12">
                            <div class="white-box p-l-20 p-r-20">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="input1" required disabled="true" placeholder="SOLAR TANK">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input21" name="brand1" required>
                                                <option>Brand</option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input4" required>
                                                ...
                                                <option>480mm dia, (7.2ft L)</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="input5" required disabled="true" placeholder="SOLAR TUBE">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input22" name="brand2" required>
                                                <option>Brand</option>
                                                <option>Waree</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input8" required>
                                                <option>Specification</option>
                                                <option>Evacuated Tube Collector</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="input9" required disabled="true" placeholder="STAND">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input23" name="brand3" required>
                                                <option>Brand</option>
                                                <option>MNRE Approved</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input12" required>
                                                <option>Specification</option>
                                                <option>Cold dip Galvanize</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="input13" required disabled="true" placeholder="SILICON RING, PUF & ACCESSORIES">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input24" name="brand4" required>
                                                <option>Brand</option>
                                                <option>MNRE Approved</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            <input type="text" class="form-control" id="input17" required disabled="true" placeholder="SYSTEM WET WEIGHT">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group m-b-40">
                                            ...
                                            <select class="form-control p-0" id="input25" name="brand5" required>
                                                <option>Brand</option>
                                                <option>MNRE Approved</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                ...
                                <input type="hidden" value="<?php echo $invid8?>" name="invid8" id="invid8">

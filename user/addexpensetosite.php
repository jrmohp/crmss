      ...
      {       
          ...
          $totalid=$val+"total"; 
            ...
            echo'<div class="row">
                  ...
                  <input type="text" name="$quantid" id="$quantid" class="form-control"placeholder='Quantity'  onchange="total('postcharge')">     
            </div><br>

            <div class="col-md-4 col-sm-4 col-xs-12"  >
                      <label for="$rateid" class="col-md-1 col-sm-1 col-xs-1"><span class="label label-info">'.$val.' Rate'.'</span></label>

                  <input type="text" name="$rateid" id="$rateid" class="form-control" placeholder='Rate'  onchange="total('postcharge')">     
            </div><br> 
            <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-12"  >
